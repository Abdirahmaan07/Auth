                        ...
                        <div class="card-body">
                            ...
                            <form action="logincode.php" method="POST">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" name="email_user" value="<?php echo (isset($_SESSION['new_email']) ? $_SESSION['new_email'] : ''); ?>"  class="form-control" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="">Password</label>
                                    <input type="password" name="password" value="<?php echo (isset($_SESSION['new_password']) ? $_SESSION['new_password'] : ''); ?>"
